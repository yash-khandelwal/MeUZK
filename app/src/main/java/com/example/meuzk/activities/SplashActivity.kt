...
class SplashActivity : AppCompatActivity() {
        ...
        when(requestCode){
            131->{
                    ...
                    && grantResults[4] == PackageManager.PERMISSION_GRANTED)
                {
                    ...
                    Toast.makeText(this@SplashActivity, "Please grant all permissions to proceed", Toast.LENGTH_SHORT).show()
                    this.finish()
                }
                return
            }
    ...
    fun gotAllPermissionsSoProceed(){
        Handler().postDelayed({
